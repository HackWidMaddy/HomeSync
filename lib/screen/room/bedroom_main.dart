...
class BedroomMain extends StatefulWidget {
  const BedroomMain({super.key});

  @override
  State<BedroomMain> createState() => _BedroomMainState();
}

class _BedroomMainState extends State<BedroomMain> {
