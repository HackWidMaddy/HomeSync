...
class BathroomMain extends StatefulWidget {
  const BathroomMain({super.key});

  @override
  State<BathroomMain> createState() => _BathroomMainState();
}

class _BathroomMainState extends State<BathroomMain> {
